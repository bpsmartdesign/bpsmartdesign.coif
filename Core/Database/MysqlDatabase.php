<?php
	...
	class MysqlDatabase extends Database{
		...
		private function getPDO(){
			...
			if($this->pdo === NULL){
				try {
					$pdo = new PDO('mysql:host=localhost;dbname=coif;charset=utf8', 'root', '', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
					// $pdo = new PDO('mysql:host=localhost;dbname=id6985400_gestionexphair;charset=utf8', 'id6985400_bpd237', 'Try_Again!0_Coif', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
				} catch (Exception $e) {
